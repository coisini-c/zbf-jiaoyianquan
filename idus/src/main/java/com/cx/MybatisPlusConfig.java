...
//        String moduleName = "";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/power?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("918273");
...
//        pc.setModuleName(scanner("请输入你的包名"));
        //需要修改
        pc.setParent("com.cx");//你哪个父目录下创建包
...
//        strategy.setInclude(scanner("表名，多个英文逗号分割").split(","));
        //需要修改
        strategy.setInclude("base_menu","base_user","base_user_role","base_role","base_role_menu");
